...
function getDaftarTempatPraktek($conn_db2)
{
...
function getDaftarDokter($conn_db2)
{
...
try {
    $query = "SELECT jr.*, tp.Nama_Tempat, d.Nama_Dokter 
                        ...
                        <?php if (count($jadwal_rutin) > 0): ?>
                            <?php foreach ($jadwal_rutin as $index => $jr): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($jr['Jenis_Layanan']); ?></td>
                                    <td>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select name="tempat_praktek" class="form-select" required>
                            ...
                            <?php foreach (getDaftarTempatPraktek($conn_db2) as $tp): ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="dokter" class="form-select" required>
                            ...
                            <?php foreach (getDaftarDokter($conn_db2) as $d): ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.edit-jadwal').forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            document.getElementById('edit_jenis_layanan').value = jadwal.Jenis_Layanan;
